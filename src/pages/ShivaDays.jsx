...
import { Calendar, Sun, Moon, Sparkles, ChevronDown, ChevronUp, Flame, Info, CheckCircle2 } from 'lucide-react';
    ...
    <div className="space-y-10 animate-fadeIn pb-8 max-w-5xl mx-auto">
      ...
      <div className="p-4 rounded-2xl bg-temple-cream border border-temple-gold/40 shadow-sm flex items-start gap-3">
        ...
        <div className="text-xs text-temple-stoneLight leading-relaxed">
          ...
          இப்பக்கத்தில் குறிப்பிடப்பட்டுள்ள விவரங்கள் அனைத்தும் <strong className="text-temple-maroon">“சைவ மரபில் சிறப்பாகக் கருதப்படும் நாட்கள்”</strong> பற்றிய பொதுவான ஆன்மிக வழிகாட்டியாகும். இத்திருக்கோயிலில் பிரதோஷம், மகா சிவராத்திரி, மார்கழி வழிபாடுகள் வழக்கமாக நடைபெறுகின்றன.
        </div>
      </div>
